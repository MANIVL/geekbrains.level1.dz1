package ru.geekbrains.java1.makerov.nikolai.dz.dz8;
...
public class Win extends JFrame {
    public Win() {
        ...
        for (int i = 0; i < jp.length; i++) {
            jp[i] = new JPanel();
            this.add(jp[i]);
            jp[i].setBackground(new Color(10 + i * 40, 10 + i * 40, 10 + i * 40));
        }
        ...
        jcombo1.addActionListener(e -> jta.append("Привет"));
...
//        });
        ...
        jp[4].setLayout(new GridLayout(2,2));
        ...
        String[][] stringNumber  = {{"","","",""},{"","","",""},{"","","",""},{"","","",""}};
        JTable table = new JTable(stringNumber, columnNumbers);
        jp[5].setLayout(new GridLayout());
        add(table);
        jp[5].add(table);
